...
// Crea un oggetto Date da una stringa di data
let someDate = new Date("2023-11-08");

// Crea un oggetto Date da un timestamp (millisecondi dal 1 gennaio 1970 00:00:00 UTC)
let timestampDate = new Date(1234567890000);

// Crea un oggetto Date specificando anno, mese (0-11), giorno (1-31), ore (0-23), minuti (0-59), secondi (0-59) e millisecondi (0-999)
